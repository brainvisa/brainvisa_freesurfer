...
def execution(self, context):
    ...
    # context.system('python2', '-c', 'from freesurfer.GiftiToBrainvisa import
    # GiftiToBrainvisa as f; f(\"%s\", \"%s\"); '%(self.PialGifti.fullPath(),
    # self.PialMesh.fullPath()))
    ...
    # context.system('python2', '-c', 'from freesurfer.GiftiToBrainvisa import
    # GiftiToBrainvisa as f; f(\"%s\", \"%s\"); '%(self.WhiteGifti.fullPath(),
    ...
    # context.system('python2', '-c', 'from freesurfer.GiftiToBrainvisa import
    # GiftiToBrainvisa as f; f(\"%s\", \"%s\");
    # '%(self.SphereRegGifti.fullPath(), self.SphereRegMesh.fullPath()))
