...
def execution(self, context):
  ...
  context.write('mri_annotation2label --subject %s --hemi %s --annotation %s --labelbase %s'%(self.subject, side, self.Gyri.fullName()[self.Gyri.fullName().rfind('/')+4:], self.Gyri.fullPath()[self.Gyri.fullPath().rfind('/')+1:]))
  ...
  context.write('mri_annotation2label --subject %s --hemi %s --annotation %s --labelbase %s'%(self.subject, side, self.SulciGyri.fullName()[self.SulciGyri.fullName().rfind('/')+4:], self.SulciGyri.fullPath()[self.SulciGyri.fullPath().rfind('/')+1:]))
