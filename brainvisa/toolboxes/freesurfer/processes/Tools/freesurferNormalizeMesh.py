...
def execution(self, context):
  ...
  context.system('python2', '-c', 'from freesurfer.normalizeMesh import normalizeMesh as f; f(\"%s\", \"%s\", \"%s\", \"%s\", \"%s\");'%(self.anat.fullPath(), self.matrix.fullPath(), self.normAnat.fullPath(), self.whiteMesh.fullPath(), self.whiteNormMesh.fullPath()))
