...
def initialization(self):
    def fill_databases(proc):
        databases = [
            h.name for h in neuroHierarchy.hierarchies() if h.fso.name == 'freesurfer']
    ...
    def linkAnatImage(proc, dummy):
        if proc.subjectName is not None and proc.database is not None:
            ...
            return filename
# self.linkParameters( 'AnatImage', ( 'subjectName', 'database' ),
# linkAnatImage )

    eNode = SerialExecutionNode(self.name, parameterized=self)

    eNode1 = ParallelExecutionNode(
        'FreeSurfer Cross-Sectional Pipeline', parameterized=self)
    ...
    eNode.addChild('FreeSurferAverageSubjectLongitudinal01',
                   ...
                   'freesurferAverageSubjectLongitudinal',
                   optional=1))
    ...
    eNode1.addDoubleLink(
        'RawT1ImageTimepoint1', 'FreeSurferSubjectTp1.RawT1Image')
    eNode1.addDoubleLink(
        'RawT1ImageTimepoint2', 'FreeSurferSubjectTp2.RawT1Image')

    eNode.addDoubleLink(
        'FreeSurferCrossSectional.FreeSurferSubjectTp1.FreeSurfer01.AnatImage',
                        'FreeSurferAverageSubjectLongitudinal01.AnatImageTimepoint1')
    eNode.addDoubleLink(
        'FreeSurferCrossSectional.FreeSurferSubjectTp2.FreeSurfer01.AnatImage',
                        'FreeSurferAverageSubjectLongitudinal01.AnatImageTimepoint2')

    eNode.addDoubleLink(
        'FreeSurferAverageSubjectLongitudinal01.AnatImageTimepoint1',
                        'FreeSurferLongitudinal.FreeSurferLongitudinalTp1.AnatImageTimepoint')
    eNode.addDoubleLink(
        'FreeSurferAverageSubjectLongitudinal01.AnatImageTimepoint2',
                        'FreeSurferLongitudinal.FreeSurferLongitudinalTp2.AnatImageTimepoint')
    eNode.addDoubleLink('FreeSurferAverageSubjectLongitudinal01.AnatImage',
                        'FreeSurferLongitudinal.FreeSurferLongitudinalTp1.AnatImageTemplate')
    eNode.addDoubleLink('FreeSurferAverageSubjectLongitudinal01.AnatImage',
                        'FreeSurferLongitudinal.FreeSurferLongitudinalTp2.AnatImageTemplate')

    print(eNode.child('FreeSurferCrossSectional')
          .child('FreeSurferSubjectTp1').child('FreeSurfer01').signature)
    # print(eNode.child('FreeSurferLongitudinal').child('FreeSurferLongitudinalTp1').signature)
    eNode.addDoubleLink(
        'FreeSurferCrossSectional.FreeSurferSubjectTp1.FSdatabase', 'FSdatabase')
    eNode.addDoubleLink(
        'FreeSurferCrossSectional.FreeSurferSubjectTp2.FSdatabase', 'FSdatabase')
    eNode.FreeSurferCrossSectional.FreeSurferSubjectTp1.addDoubleLink(
        'FSdatabase', 'FreeSurfer01.database')
    eNode.FreeSurferCrossSectional.FreeSurferSubjectTp2.addDoubleLink(
        'FSdatabase', 'FreeSurfer01.database')

    eNode1.FreeSurferSubjectTp1.FreeSurfer01.linkParameters(
        'subjectName', 'RawT1Image', linkSubjectName)
    eNode1.FreeSurferSubjectTp1.FreeSurfer01.linkParameters(
        'AnatImage', 'subjectName', linkAnatImage)
    eNode1.FreeSurferSubjectTp2.FreeSurfer01.linkParameters(
        'subjectName', 'RawT1Image', linkSubjectName)
    eNode1.FreeSurferSubjectTp2.FreeSurfer01.linkParameters(
        'AnatImage', 'subjectName', linkAnatImage)
