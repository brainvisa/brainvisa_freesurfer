...
def usage():
    ...
    print(
        "usage : freesurferTexture2Tex.py freesurferTexturesPath brain_mesh output_texture")
    print("")
    print(
        "Info: freesurferTexturesPath should be like /data/subject/label/lh.aparc.annot")
