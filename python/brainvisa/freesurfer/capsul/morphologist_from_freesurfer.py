...
class MorphologistFromFreesurfer(Pipeline):
    ...
    def pipeline_definition(self):
        ...
        self.export_parameter("import_fs", "brain_mask_output", "BrainSegmentation_brain_mask", is_optional=False)
